...
RUN uv venv /app/.venv && \
    uv pip install --python /app/.venv/bin/python "/wheels/$(basename "$(find /wheels -name '*.whl' -print -quit)")[neo4j,otel,rabbitmq]" && \
...
LABEL org.opencontainers.image.title="discogs-graph-enricher" \
